package org.example.langchain4jaidemo2.listener;
...
public class TestChatModelListener implements ChatModelListener {
    ...
    public void onRequest(ChatModelRequestContext requestContext) {
        ...
        requestContext.attributes().put("TraceID-java0923", uuidValue);
        log.info("*****************>请求参数requestContext:{}", requestContext + "\t" + uuidValue);
    }

    @Override
    public void onResponse(ChatModelResponseContext responseContext) {
        Object object = responseContext.attributes().get("TraceID-java0923");
